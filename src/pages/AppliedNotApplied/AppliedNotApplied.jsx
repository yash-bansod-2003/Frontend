...
function TableData() {
      ...
      function convertJsonToExcel(jsonData, filename) {
            ...
            // Convert workbook to Excel binary file
                  ...
                  <div className="flex justify-between items-center">
                        ...
                        <div className="flex gap-4 items-center">
                              ...
                              >
                                    ...
                                    {
                                          post.map((post, index) => (
                                                <option key={post?._id} value={post?._id}>{post?.company_Name}</option>
                                          ))
                                    }
                              </select>
                              <button
                                    onClick={() => downloadCSV(data.map(item => item.student), "studentdata")}
                                    type="submit"
                              ...
                              <button
                                    onClick={() => convertJsonToExcel(data.map(item => item.student), "studentdataexcl")}
                                    type="submit"
                                    className="w-full md:w-1/2 text-white bg-[#4F46E5] focus:ring-0 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2 text-center dark:bg-[#4F46E5]  dark:focus:ring-blue-800 mx-auto"
                              >
                                    Export to Excel

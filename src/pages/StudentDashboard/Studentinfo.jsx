                    ...
                    <div className="sm:col-span-2">
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          name="Last Name"
                          id="Last Name"
                          value={user?.I_Semester_Percentage}
                          autoComplete="Last Name"
                          className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full py-3 px-5 dark:bg-[#1e293b] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light outline-transparent text-base"
                          placeholder="SGPA"
                        />
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          name="Last Name"
                          id="Last Name"
                          value={user?.II_Semester_Percentage}
                          autoComplete="Last Name"
                          className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full py-3 px-5 dark:bg-[#1e293b] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light outline-transparent text-base"
                          placeholder="SGPA"
                        />
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          name="Last Name"
                          id="Last Name"
                          value={user?.III_Semester_Percentage}
                          autoComplete="Last Name"
                          className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full py-3 px-5 dark:bg-[#1e293b] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light outline-transparent text-base"
                          placeholder="SGPA"
                        />
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          name="Last Name"
                          id="Last Name"
                          value={user?.IV_Semester_Percentage}
                          autoComplete="Last Name"
                          className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full py-3 px-5 dark:bg-[#1e293b] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light outline-transparent text-base"
                          placeholder="SGPA"
                        />
